...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robond/Desktop/ROS/goChaseIt/catkin_ws/install/${idir}'.  Ask the maintainer 'robond <robond@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robond/Desktop/ROS/goChaseIt/catkin_ws/install/lib;/home/robond/Desktop/ROS/goChaseIt/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
